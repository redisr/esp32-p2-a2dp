...
void bt_a2dp_init()
{
    ...
    /** Bluetooth mode for controller enable/disable. 
      * ESP_BT_MODE_IDLE        Bluetooth is not running
      * ESP_BT_MODE_BLE         Run BLE mode 
      * ESP_BT_MODE_CLASSIC_BT  Run Classic BT mode
      * ESP_BT_MODE_BTDM        Run dual mode 
      */
...
static void filter_inquiry_scan_result(esp_bt_gap_cb_param_t *param)
{
    ...
    if (eir) {
        ...
        if (strcmp((char *)peer_bdname, "AMW-810S") != 0) {
            return;
        }
